...
> The initial release of the Embedding API library (version 3.0) was made available as part of Tableau 2021.4 launch. To find out about using the version 3.0 library, see the documentation for the [Tableau Embedding API v3 documentation](https://help.tableau.com/current/api/embedding_api/en-us/index.html). Embedding API library (version 3.1) is now in Developer Preview, see the [documentation for the Tableau Embedding API v3.1 documentation](https://embedding.tableauusercontent.com/preview/getting-started-v3.html).
